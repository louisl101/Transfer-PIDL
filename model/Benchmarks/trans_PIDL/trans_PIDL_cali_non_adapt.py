...
if __name__ == '__main__':
    ...
    for exper in expers:
        ...
        if exper == 'exper1':
            ...
            output_base_dir = os.path.join(root_dir, "result", "trans_PIDL", 'finetune', f'{exper}_non_adapt')
            ...
            for phase in phases:
                ...
                # Set defaults for directories
                output_base_dir = os.path.join(root_dir, "result", "trans_PIDL", 'finetune', f'{exper}_non_adapt', phase)
                if not os.path.exists(output_base_dir): os.makedirs(output_base_dir)
